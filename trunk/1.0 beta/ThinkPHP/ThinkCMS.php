...
if(!defined('RUNTIME_PATH')) define('RUNTIME_PATH',TC_DATA_PATH.'/'.APP_NAME.'_Runtime/');

if(is_file(RUNTIME_PATH.'~runtime.php') && filemtime(RUNTIME_PATH.'~runtime.php')>filemtime(THINK_PATH.'/ThinkCMS.php')) {
	// 加载框架核心缓存文件
	// 如果有修改核心文件请删除该缓存
	require RUNTIME_PATH.'~runtime.php';
}else{
	// 加载系统定义文件
	require THINK_PATH."/Common/tc_defines.php";
	// 系统函数库
	...
	if($cache) {
		...
		$content	 =	 $fun(THINK_PATH.'/Common/tc_defines.php');
